...
using System.Linq;
using System.Web;
using TiendaBazar.Models;
using MySql.Data.MySqlClient;
using System.Configuration;

namespace TiendaBazar.Data
{
    public class DataProducto
    {
        ...
        public void insertarProducto(Producto producto)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_insertarProductoBazar", conexion);
        ...
        public List<Producto> obtenerTodos()
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_obtenerProductosBazar", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void eliminarProducto(int id)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_eliminarProductoBazar", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void actualizarProducto(Producto producto)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_actualizarProductoBazar", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public Producto obtenerProducto(int id)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_obtenerProductoBazar", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@idi", id);
