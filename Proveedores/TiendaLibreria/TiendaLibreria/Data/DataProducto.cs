...
namespace TiendaLibreria.Data
{
    public class DataProducto
    {
        ...
        public void insertarProducto(Producto producto)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_insertarProductoLibreria", conexion);
        ...
        public List<Producto> obtenerTodos()
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_obtenerProductosLibreria", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void eliminarProducto(int id)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_eliminarProductoLibreria", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void actualizarProducto(Producto producto)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_actualizarProductoLibreria", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public Producto obtenerProducto(int id)
        {
            ...
            {
                conexion.Open();
                MySqlCommand com = new MySqlCommand("sp_obtenerProductoLibreria", conexion);
                com.CommandType = System.Data.CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@idi", id);
